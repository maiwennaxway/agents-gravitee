...
func AddProperties(rootProps properties.Properties) {
	...
	rootProps.AddDurationProperty(pathServicessyncdelay, 35*time.Second, "Delay of the synchronization of the Services")
	...
	rootProps.AddDurationProperty(pathServicesmondelay, 35*time.Second, "Delay of the monitoring of the Services")
