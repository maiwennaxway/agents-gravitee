...
require (
	...
	github.com/maiwennaxway/agents-gravitee/client v0.0.0-20240530095151-ac03affe255e
...
require (
	...
	github.com/elastic/beats/v7 v7.17.21 // indirect
	github.com/elastic/elastic-agent-client/v7 v7.9.0 // indirect
